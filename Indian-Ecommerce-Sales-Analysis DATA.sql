...
-- Author: SAKSHI RAI
-- Date: MARCH 2026
-- GitHub: https://github.com/Sakshi-Rai164
...
-- renaming geolocation_state to Indian States for localization
 UPDATE olist_geolocation_dataset
SET geolocation_state = 
CASE geolocation_state
    WHEN 'AC' THEN 'Andhra Pradesh'
    WHEN 'AL' THEN 'Arunachal Pradesh'
    WHEN 'AP' THEN 'Assam'
    WHEN 'AM' THEN 'Bihar'
    WHEN 'BA' THEN 'Chhattisgarh'
    WHEN 'CE' THEN 'Goa'
    WHEN 'DF' THEN 'Gujarat'
    WHEN 'ES' THEN 'Haryana'
    WHEN 'GO' THEN 'Himachal Pradesh'
    WHEN 'MA' THEN 'Jharkhand'
    WHEN 'MT' THEN 'Kerala'
    WHEN 'MS' THEN 'Madhya Pradesh'
    WHEN 'MG' THEN 'Karnataka'
    WHEN 'PA' THEN 'Odisha'
    WHEN 'PB' THEN 'Punjab'
    WHEN 'PR' THEN 'Rajasthan'
    WHEN 'PE' THEN 'Sikkim'
    WHEN 'PI' THEN 'Tamil Nadu'
    WHEN 'RJ' THEN 'Delhi'
    WHEN 'RN' THEN 'Telangana'
    WHEN 'RS' THEN 'Uttar Pradesh'
    WHEN 'RO' THEN 'Uttarakhand'
    WHEN 'RR' THEN 'West Bengal'
    WHEN 'SC' THEN 'Tripura'
    WHEN 'SP' THEN 'Maharashtra'
    WHEN 'SE' THEN 'Meghalaya'
    WHEN 'TO' THEN 'Mizoram'
END;
...
-- Replacing the abbreviated customer_state to Indian States
...
--1)  What is the total revenue generated by the platform, and how has it changed over time?
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
--2) How many orders were placed, and how does this vary by month or season?
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- 5) How many sellers are active, and how does this number change over time?
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- 7) How many customers have made repeated purchases, and what percentage of total sales do they account for?
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--9) What is the average order cancellation rate, and how does this impact seller performance?
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- 10) What are the top-selling products, and how have their sales trends changed over time?
...
--To determine the most commonly used payment methods by customers and how they vary by product category or geographic region, you can use the following SQL query:
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- 13) Which product categories have the highest profit margins, and how can the
